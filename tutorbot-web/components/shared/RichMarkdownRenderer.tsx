...
const LazyMermaid = dynamic(() => import("@/components/shared/Mermaid"), {
  ssr: false,
...
const LazyFunctionGraph = dynamic(
  () => import("@/components/shared/FunctionGraph"),
  { ssr: false, loading: () => <GraphLoading /> },
);

const LazyGeometryGraph = dynamic(
  () => import("@/components/shared/GeometryGraph"),
  { ssr: false, loading: () => <GraphLoading /> },
);
