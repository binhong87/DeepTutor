...
export default function BotSettingsPage() {
  ...
  async function handleDestroy() {
    try {
      ...
      setError(e instanceof Error ? e.message : "Failed to destroy bot");
    }
  }
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      <h1 className="text-2xl font-semibold text-[var(--foreground)] mb-2">Bot Settings</h1>
      ...
      <section className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-6 mb-6">
        <h2 className="text-sm font-semibold text-[var(--foreground)] mb-4">Identity</h2>
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--foreground)] mb-1">Persona (Soul)</label>
            <textarea
              value={persona}
      ...
      {/* Actions */}
      <section className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-6 mb-6">
        <h2 className="text-sm font-semibold text-[var(--foreground)] mb-4">Actions</h2>
